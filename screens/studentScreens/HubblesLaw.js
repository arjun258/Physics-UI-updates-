...
export default class HubblesLaw extends Component {
   constructor(props) {
    super(props);
    this.state = {
      fontsLoaded: false,
...
2) Galaxy orbiting due to gravitational movements. 
        ...
        <TouchableOpacity style={{backgroundColor:"red",marginTop:20,width:RFValue(80),height:RFValue(40),borderRadius:30,alignItems:"center"}}
