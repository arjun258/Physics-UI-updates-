...
export default class OhmsLaw extends Component {
 ...
 <View style={{marginLeft:30,flexDirection:"row"}}>
  ...
  <Image style={{width:RFValue(100),height:RFValue(100),borderRadius:RFValue(50)}}source={require("./images/Georg_Simon_Ohm3.jpg")}/>
...
<View style={{justifyContent:"center",flex:0.5}}>
        <TouchableOpacity style={{backgroundColor:"red",marginTop:-400,width:RFValue(80),height:RFValue(40),borderRadius:30,alignItems:"center"}}
